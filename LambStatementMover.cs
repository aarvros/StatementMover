...
namespace LambStatementWinForms{
public class StatementMoverForm : Form{
    ...
    private static Stream LoadIco(){
        string resourceName = "LambStatementMover.resources.lambicon.ico";
        Assembly assembly = Assembly.GetExecutingAssembly();
        Stream? stream = assembly.GetManifestResourceStream(resourceName);  // null fogriving
        return stream!;                                                     // null forgiving
    }
